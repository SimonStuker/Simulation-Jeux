/* @ts-self-types="./jeu_50missions.d.ts" */
 ...
 * @returns {number}
 */
export function run_simulation_wasm(seed) {
    _assertNum(seed);
    const ret = wasm.run_simulation_wasm(seed);
    return ret >>> 0;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('jeu_50missions_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
